...
def main() -> int:
    p = argparse.ArgumentParser(description="IPv6 UDP client with optional explicit source bind")
    ...
    p.add_argument("--timeout", type=float, default=5.0, help="Receive timeout in seconds")
    args = p.parse_args()
