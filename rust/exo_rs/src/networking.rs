pub use py_networking::*;
use pyo3::pymodule;

#[pymodule(name = "networking", gil_used = true)]
pub(crate) mod py_networking {
    use std::pin::Pin;
    use std::sync::Arc;
    ...
    mod exception {
        ...
        #[gen_stub_pyclass(module = "exo_rs.networking")]
    ...
    #[gen_stub_pyclass_complex_enum(module = "exo_rs.networking")]
