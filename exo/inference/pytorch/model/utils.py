...
# def sample_logits(logits, temp=0.3, top_k=85, top_p=2.0, alpha_f=0.1, alpha_p=0.0):
#     """
...
def sample_logits(ogits, temperature=1.0, top_k=0, top_p=1.0, alpha_f=0.0, alpha_p=0.0):
    """
