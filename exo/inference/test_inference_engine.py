...
async def test_inference_engine(inference_engine_1: InferenceEngine, inference_engine_2: InferenceEngine, model_id: str):
  ...
  resp_full, inference_state_full, _ = await inference_engine_1.infer_prompt(["A"], shard=Shard(model_id=model_id, start_layer=0, end_layer=31, n_layers=32), prompts=[prompt])
  ...
  resp1, inference_state_1, _ = await inference_engine_1.infer_prompt(["B"], shard=Shard(model_id=model_id, start_layer=0, end_layer=30, n_layers=32), prompts=[prompt])
