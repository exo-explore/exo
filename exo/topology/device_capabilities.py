...
CHIP_FLOPS = {
  ...
  # QUADRO RTX series
  "NVIDIA Quadro RTX 3000": DeviceFlops(fp32=5.40*TFLOPS, fp16=10.80*TFLOPS, int8=21.60*TFLOPS),
  "NVIDIA QUADRO RTX 3000 MXM": DeviceFlops(fp32=6.4*TFLOPS, fp16=12.8*TFLOPS, int8=25.6*TFLOPS),
  # Turing workstation GPUs
  "NVIDIA QUADRO RTX 5000": DeviceFlops(fp32=11.2*TFLOPS, fp16=22.3*TFLOPS, int8=178.4*TFLOPS),
  "NVIDIA QUADRO RTX 5000 MOBILE": DeviceFlops(fp32=9.4*TFLOPS, fp16=18.8*TFLOPS, int8=150.4*TFLOPS),
  "NVIDIA QUADRO RTX 5000 MAX-Q": DeviceFlops(fp32=8.294*TFLOPS, fp16=16.59*TFLOPS, int8=132.70*TFLOPS),
  ...
  "NVIDIA RTX 2000 Ada Generation Laptop GPU": DeviceFlops(fp32=12.99*TFLOPS, fp16=12.99*TFLOPS, int8=51.96*TFLOPS),
