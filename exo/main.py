...
parser.add_argument(
    ...
    type=str,
    choices=["available_memory", "ring_memory"],
...
if args.partitioning_strategy == "available_memory":
    partitioning_strategy = AvailableMemoryWeightedPartitioningStrategy()
elif args.partitioning_strategy == "ring_memory":
