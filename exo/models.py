...
model_cards = {
  ...
  "qwen-3-coder-30b": { "layers": 48, "repo": { "MLXDynamicShardInferenceEngine": "mlx-community/Qwen3-Coder-30B-A3B-Instruct-8bit", }, },
  ### nemotron
...
pretty_name = {
  ...
  "qwen-3-coder-30b": "Qwen 3 Coder 30B A3B Instruct 8Bit",
