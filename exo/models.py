...
model_base_shards = {
  ...
  "llama-3.2-1b": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="meta-llama/Llama-3.2-1B-Instruct", start_layer=0, end_layer=0, n_layers=16),
  },
  "llama-3.2-3b": {
  ...
  "llama-3-70b": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="NousResearch/Meta-Llama-3-70B-Instruct", start_layer=0, end_layer=0, n_layers=80),
  },
  "llama-3-2B-Base": {
    "TorchDynamicShardInferenceEngine": Shard(model_id="andrijdavid/Llama3-2B-Base", start_layer=0, end_layer=0, n_layers=6),
  },
  "llama-3-1B-Base": {
    "TorchDynamicShardInferenceEngine": Shard(model_id="andrijdavid/Llama3-1B-Base", start_layer=0, end_layer=0, n_layers=3),
  },
  ### mistral
  "mistral-nemo": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="unsloth/Mistral-Nemo-Instruct-2407", start_layer=0, end_layer=0, n_layers=40),
  },
  "mistral-large": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="mistralai/Mistral-Large-Instruct-2407", start_layer=0, end_layer=0, n_layers=88),
  },
  ### deepseek
  "deepseek-coder-v2-lite": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="deepseek-ai/DeepSeek-V2-Lite", start_layer=0, end_layer=0, n_layers=27),
  },
  "deepseek-coder-v2.5": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="deepseek-ai/DeepSeek-V2.5", start_layer=0, end_layer=0, n_layers=60),
  },
  ### llava
  "llava-1.5-7b-hf": {
  ...
  "qwen-2.5-7b": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="unsloth/Qwen2.5-7B-Instruct", start_layer=0, end_layer=0, n_layers=28),
  },
  "qwen-2.5-math-7b": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="unsloth/Qwen2.5-Math-7B-Instruct", start_layer=0, end_layer=0, n_layers=28),
  },
  "qwen-2.5-14b": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="unsloth/Qwen2.5-14B-Instruct", start_layer=0, end_layer=0, n_layers=48),
  },
  "qwen-2.5-72b": {
    ...
    "TorchDynamicShardInferenceEngine": Shard(model_id="unsloth/Qwen2.5-72B-Instruct", start_layer=0, end_layer=0, n_layers=80),
  },
  "qwen-2.5-math-72b": {
