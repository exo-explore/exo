...
from vllm.v1.attention.ops.triton_prefill_attention import (
    context_attention_fwd as context_attention_fwd,
)
...
class TritonAttentionMetadataBuilder(AttentionMetadataBuilder[TritonAttentionMetadata]):
    ...
    headdim: Incomplete
    decode_cudagraph_enabled: Incomplete
    seq_threshold_3D: Incomplete
    num_par_softmax_segments: Incomplete
    softmax_segm_output: Incomplete
    softmax_segm_max: Incomplete
    softmax_segm_expsum: Incomplete
    def __init__(
        self,
