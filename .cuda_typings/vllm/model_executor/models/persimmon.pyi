...
from transformers import PersimmonConfig as PersimmonConfig
...
class PersimmonForCausalLM(nn.Module, SupportsPP, metaclass=abc.ABCMeta):
    config: Incomplete
    vocab_size: Incomplete
    model: Incomplete
    lm_head: Incomplete
