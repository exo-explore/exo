...
from transformers import StableLmConfig as StableLmConfig
...
class StablelmAttention(nn.Module):
    ...
    total_num_key_value_heads: Incomplete
...
class StablelmForCausalLM(nn.Module, SupportsPP, metaclass=abc.ABCMeta):
    config: Incomplete
