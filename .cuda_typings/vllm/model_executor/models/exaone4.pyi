...
from transformers import Exaone4Config as Exaone4Config
...
class Exaone4Attention(nn.Module):
    ...
    apply_rope_all_layers: Incomplete
...
class Exaone4ForCausalLM(nn.Module, SupportsLoRA, SupportsPP, metaclass=abc.ABCMeta):
