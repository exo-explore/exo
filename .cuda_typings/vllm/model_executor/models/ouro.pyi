import torch
from .interfaces import SupportsLoRA as SupportsLoRA
from .utils import (
...
class OuroDecoderLayer(nn.Module):
    ...
    input_layernorm_2: Incomplete
    post_attention_layernorm: Incomplete
    post_attention_layernorm_2: Incomplete
    def __init__(
        self,
        config: PretrainedConfig,
        cache_config: CacheConfig | None = None,
...
class OuroModel(nn.Module):
    ...
    norm: Incomplete
    early_exit_gate: Incomplete
    total_ut_steps: Incomplete
    def __init__(
        self,
        *,
