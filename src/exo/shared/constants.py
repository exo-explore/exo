...
# Back-compat aliases for older callers that still expect the legacy single-dir/path surface.
EXO_MODELS_DIR = EXO_DEFAULT_MODELS_DIR
EXO_MODELS_PATH: tuple[Path, ...] | None = EXO_MODELS_READ_ONLY_DIRS or None
