...
MODEL_CARDS: dict[str, ModelCard] = {
    ...
    "glm-4.7-flash-4bit": ModelCard(
        ...
        name="GLM 4.7 Flash (4-bit, MLX)",
        description="""GLM-4.7-Flash 30B-A3B MoE (4-bit) MLX conversion.""",
        tags=["glm-4.7", "flash"],
        metadata=ModelMetadata(
            model_id=ModelId("mlx-community/GLM-4.7-Flash-4bit"),
            pretty_name="GLM 4.7 Flash (4-bit, MLX)",
            storage_size=Memory.from_bytes(16_852_202_496),
            n_layers=47,
            hidden_size=2048,
            supports_tensor=True,
        ),
    ),
    "glm-4.7-reap-50-mxfp4": ModelCard(
        short_id="glm-4.7-reap-50-mxfp4",
        model_id=ModelId("mlx-community/GLM-4.7-REAP-50-mxfp4"),
        name="GLM 4.7 REAP 50 (MXFP4, MLX)",
        description="""GLM 4.7 REAP 50 (MXFP4) MLX conversion.""",
        tags=["reap"],
        metadata=ModelMetadata(
            model_id=ModelId("mlx-community/GLM-4.7-REAP-50-mxfp4"),
            pretty_name="GLM 4.7 REAP 50 (MXFP4, MLX)",
            storage_size=Memory.from_bytes(98_221_035_328),
            n_layers=92,
            hidden_size=5120,
            supports_tensor=True,
        ),
