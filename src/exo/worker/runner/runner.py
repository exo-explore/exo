...
from exo.shared.types.api import ChatCompletionMessageText, ChatCompletionTaskParams, ImageGenerationStats
            ...
            match task:
                ...
                case LoadModel() if (
                    ...
                    if ModelTask.TextGeneration in shard_metadata.model_card.tasks:
                        ...
                        # Image generation uses lazy MLX imports
                ...
                case StartWarmup() if isinstance(current_status, RunnerLoaded):
                    ...
                    if ModelTask.TextGeneration in shard_metadata.model_card.tasks:
                        ...
                        # Image warmup uses lazy MLX imports
                ...
                case ChatCompletion(task_params=task_params, command_id=command_id) if (
                    ...
                    # task_params is already ChatCompletionTaskParams from the pattern match
                    assert isinstance(task_params, ChatCompletionTaskParams)
                ...
                case ImageEdits(task_params=task_params, command_id=command_id) if (
                    ...
                    # Image edits uses lazy MLX imports
                    from exo.worker.engines.image import DistributedImageModel, generate_image
                    assert isinstance(model, DistributedImageModel)
...
def _check_for_debug_prompts(
    ...
    if EXO_RUNNER_MUST_OOM in prompt:
        # Lazy import for MLX-only feature
